...
const friends = [
  { name: 'Jane Doe', imgUrl: 'https://randomuser.me/api/portraits/women/44.jpg' },
  { name: 'John Smith', imgUrl: 'https://randomuser.me/api/portraits/men/44.jpg' },
  { name: 'Alice Johnson', imgUrl: 'https://randomuser.me/api/portraits/women/51.jpg' },
  { name: 'Bob Brown', imgUrl: 'https://randomuser.me/api/portraits/men/51.jpg' },
]
            ...
            <div className="px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
                  {friends.map((friend) => (
                    <div key={friend.name} className="flex items-center gap-x-3">
                      <img
